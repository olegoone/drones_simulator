...
void PIDPositionController::initialize_ros()
{
    ...
    // ROS publishers
    airsim_vel_cmd_world_frame_pub_ = nh_.advertise<airsim_ros_pkgs::VelCmd>("vel_cmd_world_frame", 1);

    onGoalReachedPublisher_ = nh_.advertise<std_msgs::Empty>("goal_reached", 1, false);
 
    // ROS subscribers
    airsim_odom_sub_ = nh_.subscribe("odom_local_ned", 50, &PIDPositionController::airsim_odom_cb, this);
    home_geopoint_sub_ = nh_.subscribe("home_geo_point", 50, &PIDPositionController::home_geopoint_cb, this);
    ...
    local_position_goal_override_srvr_ = nh_.advertiseService("local_position_goal/override", &PIDPositionController::local_position_goal_srv_override_cb, this);
    gps_goal_srvr_ = nh_.advertiseService("gps_goal", &PIDPositionController::gps_goal_srv_cb, this);
    gps_goal_override_srvr_ = nh_.advertiseService("gps_goal/override", &PIDPositionController::gps_goal_srv_override_cb, this);
...
void PIDPositionController::onGoalReached() {
